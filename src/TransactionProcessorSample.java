...
public class TransactionProcessorSample {
    ...
    public static void main(final String[] args) throws IOException {
        List<User> users = Helper.readUsers(Paths.get(args[0]));
        List<Transaction> transactions = Helper.readTransactions(Paths.get(args[1]));
//        List<dto.BinMapping> binMappings = TransactionProcessorSample.readBinMappings(Paths.get(args[2]));
//
//        List<dto.Event> events = TransactionProcessorSample.processTransactions(users, transactions, binMappings);
//
